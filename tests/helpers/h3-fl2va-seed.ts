...
export const H3_FL2VA_SEED: Array<{ key: string; value: string; type: SeedType }> = [
  ...
  { key: 'h3-fl2va.chunk_feedforward_min_tokens', value: '1024', type: 'number' },
  ...
  { key: 'h3-fl2va.sol_attn_min_tokens', value: '111', type: 'number' },
  ...
  { key: 'h3-fl2va.megapixels_last', value: '0.37', type: 'number' },
