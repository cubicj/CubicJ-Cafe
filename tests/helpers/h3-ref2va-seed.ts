...
export const H3_REF2VA_SEED: Array<{ key: string; value: string; type: SeedType }> = [
  ...
  { key: 'h3-ref2va.unet_weight_dtype', value: 'default', type: 'string' },
  ...
  { key: 'h3-ref2va.clip_device', value: 'default', type: 'string' },
  ...
  { key: 'h3-ref2va.sampler', value: 'euler', type: 'string' },
  { key: 'h3-ref2va.scheduler', value: 'simple', type: 'string' },
  ...
  { key: 'h3-ref2va.video_format', value: 'video/h264-mp4', type: 'string' },
  { key: 'h3-ref2va.video_pix_fmt', value: 'yuv420p', type: 'string' },
  { key: 'h3-ref2va.rtx_enabled', value: 'true', type: 'boolean' },
  { key: 'h3-ref2va.rtx_resize_type', value: 'scale by multiplier', type: 'string' },
  { key: 'h3-ref2va.rtx_scale', value: '2', type: 'number' },
