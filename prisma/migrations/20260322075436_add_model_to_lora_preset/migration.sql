...
INSERT INTO "new_lora_presets" ("created_at", "id", "is_default", "is_public", "name", "order", "updated_at", "user_id") SELECT "created_at", "id", "is_default", "is_public", "name", "order", "updated_at", "user_id" FROM "lora_presets";
