...
export const H3_REF2VA_NO_VIDEO_WORKFLOW_TEMPLATE = {
  '1': {
    inputs: { shift_video: 0, shift_audio: 0, model: ['7', 0] },
  ...
  '58': {
    inputs: { video_latent: ['57', 0], audio_latent: ['28', 1] },
