export const LTXA = {
  ...
  ATTENTION_TUNER: '677',
  FIRST_PASS_DISTILLED_LORA: '680',
  SECOND_PASS_DISTILLED_LORA: '681',
  SECOND_PASS_REFERENCE_AUDIO: '684',
  SECOND_PASS_ADD_GUIDE: '712',
  SECOND_PASS_CROP_GUIDES: '713',
  SECOND_PASS_PREPROCESS: '714',
  SECOND_PASS_SAMPLER_SELECT: '715',
  UNET_LOADER: '716',
  VIDEO_VAE: '718',
  DUAL_CLIP: '722',
} as const;
