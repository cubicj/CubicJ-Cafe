...
const H3_REF2VA_FIELDS: SettingsField[] = [
  ...
  { key: 'h3-ref2va.attention_backend', label: 'Attention Backend', type: 'nodeOption', group: 'H3R — 샘플러', nodeQuery: 'attention_backend:ModelAttentionBackend:attention' },
  { key: 'h3-ref2va.fused_modulation', label: 'Fused Modulation', type: 'boolean', group: 'H3R — 샘플러' },
  ...
  { key: 'h3-ref2va.chunk_feedforward_min_tokens', label: 'Min Tokens', type: 'number', step: 1, group: 'H3R — 샘플러' },

  { key: 'h3-ref2va.sol_attn_enabled', label: 'Sol Attention', type: 'boolean', group: 'H3R — Sol Attention' },
  { key: 'h3-ref2va.sol_attn_tau_start', label: 'Tau Start', type: 'number', step: 0.1, group: 'H3R — Sol Attention' },
  { key: 'h3-ref2va.sol_attn_tau_end', label: 'Tau End', type: 'number', step: 0.1, group: 'H3R — Sol Attention' },
  { key: 'h3-ref2va.sol_attn_curve', label: 'Curve', type: 'nodeOption', group: 'H3R — Sol Attention', nodeQuery: 'sol_attn_curve:MiniMaxH3ScheduledSolAttentionPatch:curve' },
  { key: 'h3-ref2va.sol_attn_min_tokens', label: 'Min Tokens', type: 'number', step: 1, group: 'H3R — Sol Attention' },
  { key: 'h3-ref2va.sol_attn_strict', label: 'Strict', type: 'boolean', group: 'H3R — Sol Attention' },
  { key: 'h3-ref2va.sol_attn_dense_percent', label: 'Dense Percent', type: 'number', step: 0.1, group: 'H3R — Sol Attention' },
  { key: 'h3-ref2va.sol_attn_thresh_type', label: 'Thresh Type', type: 'nodeOption', group: 'H3R — Sol Attention', nodeQuery: 'sol_attn_thresh_type:MiniMaxH3ScheduledSolAttentionPatch:thresh_type' },
  { key: 'h3-ref2va.sol_attn_int8_qk', label: 'INT8 QK', type: 'boolean', group: 'H3R — Sol Attention' },
  { key: 'h3-ref2va.sol_attn_int8_pv', label: 'INT8 PV', type: 'boolean', group: 'H3R — Sol Attention' },
  { key: 'h3-ref2va.sol_attn_sink_conditioning', label: 'Sink Conditioning', type: 'nodeOption', group: 'H3R — Sol Attention', nodeQuery: 'sol_attn_sink_conditioning:MiniMaxH3ScheduledSolAttentionPatch:sink_conditioning' },
